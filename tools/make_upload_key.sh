...
#   ~/HonestArcadeApps/secrets/<APP_SLUG>-upload.keystore
#   ~/HonestArcadeApps/secrets/<APP_SLUG>-signing-credentials.txt
#
# Set APP_SLUG below (a short, filename-safe app identifier, e.g. "sudoku")
# and ORG_NAME/APP_DISPLAY_NAME for the certificate's distinguished name.
set -euo pipefail
...
# Shown in the certificate's distinguished name only.
ORG_NAME="${HS_ORG_NAME:-Honest Arcade}"
APP_DISPLAY_NAME="${HS_APP_DISPLAY_NAME:-Honest Solitaire}"
